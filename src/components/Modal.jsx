...
export const Modal = (props) => {
  ...
  return (
    <div className='modal_layout' onClick={closeModal}>
        <div className="modal" onClick={e => e.stopPropagation()}>
            <div className="flex">
                <div className="modal_name">{modalData.name}</div>
            ...
            <div className='info_row'>
                <h6>Дата приема:</h6>
                <p>{modalData.hire_date}</p>
            </div>
            <div className='info_row'>
                <h6>Должность:</h6>
                <p>{modalData.position_name}</p>
            </div>
            <div className='info_row'>
                <h6>Подразделение:</h6>
                <p>{modalData.department}</p>
            </div>
            <div className="modal_title">Дополнительная информация:</div>
